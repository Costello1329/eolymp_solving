...
int main () {
	Segment2D<long double> segment1;
	Segment2D<long double> segment2;
	cin >> segment1 >> segment2;
	
	Segment2D<long double> intersection;

	
	cout << fixed << setprecision(10);

	if (!getSegmentsIntersection(segment1, segment2, intersection))
		cout << "Empty" << endl;

	else if (intersection.begin == intersection.end)
